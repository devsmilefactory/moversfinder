...
const DriverOperatorMatching = ({ formData, setFormData, errors, setErrors }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Vehicle Search (if operator selected) */}
      {selectedOperator && !proceedManually && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start gap-3 mb-4">
            <Icon name="Search" className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
            <div>
              <h4 className="font-semibold text-blue-900">Vehicle Lookup</h4>
