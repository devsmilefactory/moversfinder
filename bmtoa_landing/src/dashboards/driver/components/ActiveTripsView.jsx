  ...
  const getNextActionButton = (trip) => {
    ...
    return (
      <Button
        ...
        onClick={() => updateTripStatus(trip.id, action.status)}
        ...
        {selectedTrip ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="h-96 relative">
              <MapView
                center={selectedTrip.pickup_coordinates || { lat: -20.1594, lng: 28.5833 }}
                zoom={13}
                markers={[
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-sm font-medium text-gray-500 mb-2">Passenger Information</p>
                <p className="text-gray-900 font-medium">User ID: {selectedTrip.user_id}</p>
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-200">
                ...
                <Button variant="outline" onClick={() => alert('Navigation feature coming soon!')}>
                  Navigate
                </Button>
              </div>
            </div>
