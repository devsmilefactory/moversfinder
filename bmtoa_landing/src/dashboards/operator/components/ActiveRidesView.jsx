...
const ActiveRidesView = () => {
  ...
  const handleCancelRide = async (rideId) => {
    ...
    try {
      ...
      // Clear selection if cancelled ride was selected
            ...
            <div className="p-6 space-y-4">
              ...
              {selectedRide.driver_id && (
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-gray-900 font-medium">Driver ID: {selectedRide.driver_id}</p>
                  <p className="text-sm text-gray-600 mt-1">Contact driver for updates</p>
                </div>
              )}
