-- Migration: Fix all column mismatches in RPC functions
-- Fixes: special_instructions (doesn't exist), n.is_read -> n.read, distance_to_driver_km type mismatch
...
-- ============================================================================
-- Fix get_active_instant_ride function
-- ============================================================================
...
BEGIN
  ...
  SELECT
    ...
    r.dropoff_location,
    r.distance_km,
    NULL::NUMERIC AS distance_to_driver_km,
    r.created_at,
    r.scheduled_datetime AS start_time,
    NULL::INT AS total_trips,
    NULL::INT AS trips_done,
...
-- ============================================================================
-- Fix get_imminent_scheduled_rides function
-- ============================================================================
