-- Migration: Update accept_driver_bid RPC to set active_ride_id
-- Date: 2025-12-14
-- Purpose: Mark driver as engaged when accepting a bid by setting active_ride_id and is_available = false

-- Drop existing function first
DROP FUNCTION IF EXISTS public.accept_driver_bid(uuid, uuid, uuid, uuid);

-- Recreate with active_ride_id update
CREATE FUNCTION public.accept_driver_bid(
    p_ride_id uuid,
    p_offer_id uuid,
    p_driver_id uuid,
    p_passenger_id uuid
